    ...
    private void listarAutoresVivos() {
        ...
        if (autores.isEmpty()) {
            ...
            autores.forEach(autor -> {
                if(autor.getDataDaMorte() != null){
                    String nomeAutor = autor.getNome();
                    String anoNascimento = autor.getDataDeNascimento().toString();
                    String anoFalecimento = autor.getDataDaMorte().toString();
    ...
    private void listarLivrosPorIdioma() {
        ...
        if (livros.isEmpty()) {
            ...
            livros.forEach(livro -> {
                ...
                String idiomaLivro = livro.getLinguagens();
